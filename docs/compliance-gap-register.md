...
| Risk register | ISO 27001, DORA, NIS2, CSF | Unified register now tracks due dates, residual risk, linked controls, and verifier-backed overdue escalation state, but independent residual-risk acceptance evidence remains partial | Central risk log with owner, treatment, due date, residual risk |
