...
- **Phase 40: Pilot Cadence** — weekly scheduled pilots + fault injections with committed evidence; regression auto-issues. *(REQ-1.5.4 — complete)* — **2 plans**
  - [x] 40-01-PLAN.md — Pilot-cadence runner (isolated worktrees, dated evidence via PR) + dedupe-guarded regression issue filer
  - [x] 40-02-PLAN.md — Weekly Scheduled Task registration + seeded-regression falsifier drill
