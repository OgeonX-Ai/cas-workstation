...
- **Phase 38: Merge Flow & Hygiene Backfill** — auto-merge/merge-queue policy with a real second reviewer; drain-residuals backfill (kept branches, worktree leftovers, root protection decision). *(REQ-1.5.1, 1.5.2)*
