...
- **Phase 38: Merge Flow & Hygiene Backfill** — auto-merge/merge-queue policy with a real second reviewer; drain-residuals backfill (kept branches, worktree leftovers, root protection decision). *(REQ-1.5.1, 1.5.2)* — **3 plans**
  - [x] 38-01-PLAN.md — Merge-flow policy & review-bot mechanism (eligibility classifier + critic_cli-gated review-bot App + branch-protection-as-code)
  ...
  - [x] 38-03-PLAN.md — Root-repo branch-protection decision & codification (root moves to PR flow)
